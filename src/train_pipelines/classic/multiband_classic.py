...
from cf_cl.models.build_model import build_multiband_model
...
model, optimizer, criterion = build_multiband_model(model_cfg = CONFIG.model)
...
exp_name = f"{CONFIG.name.lower()}_multiband"
if ni_scenario:
    exp_name += "_ni"
...
# ----------------------------
# MultiBand Plugin (Avalanche 0.6.0)
# ----------------------------
